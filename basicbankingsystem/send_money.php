...
<body style="background-color:#b812de; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                ...
                <h1 style=" color:yellow;">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <p style="color:yellow;">Want to check your balance? check <a href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
