...
<head>
    ...
    <title>Welcome to Sam Sparks Bank</title>
...
<body style="background-color:#de12a1;">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:yellow; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#de12a1;">
        <div class="row">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:yellow;"><b>What do you want to do?</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:yellow; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <h6>Hey, you can watch all customer of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Hey, you can send money to others from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
                            <h6>Hey, you can check the balance in your bank account.</h6>
                        </div>
                    </div>
                </div>
            </div>
